...
if __name__ == '__main__':
    #Use the second method when training the model and the first method when invoking the visual interface.
    preprocess_and_save("guess/wav/", "guess/npy/")
    #preprocess_and_save("audio/LibriSpeechSamples/npy/", "audio/LibriSpeechSamples/npy/")
