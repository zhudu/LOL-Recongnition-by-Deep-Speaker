...
CHECKPOINT_FOLDER = 'model/train-model/ResidualCNN'
BEST_CHECKPOINT_FOLDER = 'model/train-model/best_checkpoint'
PRE_CHECKPOINT_FOLDER = 'model/pre-model'
GRU_CHECKPOINT_FOLDER = 'model/train-model/GRU'
